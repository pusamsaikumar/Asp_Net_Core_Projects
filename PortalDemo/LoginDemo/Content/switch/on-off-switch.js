...
$.extend(DG.OnOffSwitch.prototype, {
    ...
    addEvents: function () {
        ...
        //Added below four lines and commented four lines for tabletools and on off switch js compatability      

        $(".on-off-switch-thumb").on("touchmove", this.drag.bind(this));
        $(".on-off-switch-thumb").on("mousemove", this.drag.bind(this));
        $(".on-off-switch-thumb").on("mouseup", this.endDrag.bind(this));
        $(".on-off-switch-thumb").on("touchend", this.endDrag.bind(this));
    ...
    renderThumb: function () {
        ...
        var shadow = $('<div class="on-off-switch-thumb-shadow" style="border-radius:' + borderRadius + 'px;width:' + 20 + 'px;height:'
            + 20 + 'px;border-width:' + borderSize + 'px;"></div>');

        this.thumb.append(shadow);

        this.thumbColor = $('<div class="on-off-switch-thumb-color" style="border-radius:' + borderRadius + 'px;width:' + 20 + 'px;height:' + 20 +
    ...
    applyStyles: function () {
        ...
        if (this.checked) {
            ...
            this.thumb.css("left", 25);
            this.onOffTrackContainer.css("left", 0);
        }
        else {
            this.onOffTrackContainer.css("left",-40);
